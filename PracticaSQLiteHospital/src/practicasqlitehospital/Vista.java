...
public class Vista extends JFrame {
    ...
    public Vista() {
        ...
        add(bMod);
        bList.setBounds(310, 10, 100, 30);
        add(bList);
        bSalir.setBounds(410, 10, 100, 30);
        add(bSalir);
        ...
        campoTexto.setBounds(10, 360, 500, 40);
        add(campoTexto);
